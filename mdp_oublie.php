...
<head>
     ...
     <title>Carrom || Mot de oublié</title>
                    ...
                    <div class="container">
                         <div class="row justify-content-center">
                              <div class="col-lg-5 text-center mx-auto">
                                   ...
                                   <p class="text-lead text-white">Mot de passe oublié</p>
                              </div>
                         </div>
                    </div>
               </div>
                                        ...
                                        <div class="card-body">
                                             <form role="form text-left" Method="post">
                                                  ...
                                                  <div class="text-center">
                                                       <button type="submit" class="btn bg-gradient cor w-100 my-4 mb-2" name="envoye">Envoyer</button>
                                                  </div>
                                                  <p class="text-sm mt-3 mb-0">Se connecter <a href="connexion.php" class="text txt font-weight-bolder">Connexion</a></p>
                                             </form>
                                        </div>
                                   </div>
                              </div>
