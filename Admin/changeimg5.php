...
if (strlen($_SESSION['user']) == 0) {
     ...
     if (isset($_POST['update'])) {
          ...
          $sql = "update vehicule set img5=:img5 where id_vehi=:id";
                         ...
                         <form action="" method="POST" enctype="multipart/form-data">
                              <div class="card">
                                   <div class="card-body p-4">
                                        <h5 class="card-title">Modifier l'image 5 </h5>
                                        <hr />
                                        <style>
                                             .errorWrap {
                                                  padding: 10px;
                                             ...
                                             <div class="row">
                                                  <div class="col-lg-10">
                                                       <div class="border border-3 p-4 rounded">
                                                            <?php
                                                            $id = intval($_GET['imgid']);
                                                            $sql = "SELECT img5 from vehicule where id_vehi=:id";
                                                            $query = $bdd->prepare($sql);
                                                            ...
                                                            if ($query->rowCount() > 0) {
                                                                 foreach ($results as $result) {     ?>
                                                                      ...
                                                                      <div class="col-sm-7">
                                                                           Image5 actuel<span style="color:red">*</span>
                                                                           <img src="img/voitureimages/<?php echo htmlentities($result->img5); ?>" width="200" height="300" style="border:solid 1px #000">
                                                                      </div>
                                                                      <div class="col-sm-7">
                                                                           pour changer
                                                                      </div>
                                                            ...
                                                            <div class="col-sm-7">
                                                                 Telecharger une nouvelle image <span style="color:red">*</span><input type="file" name="img5" required>
                                                            </div>
