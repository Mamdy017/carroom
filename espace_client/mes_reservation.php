                                ...
                                <div class="table-responsive p-0">
                                    <table id="example" class="tabl align-items-center mb-0">
                                        ...
                                        <tbody style="">
                                            ...
                                            $sql = "SELECT reservation.id,reservation.total, vehicule.img1 as photo1,vehicule.nom,vehicule.id_vehi ,vehicule.marque as vid,reservation.debut,reservation.fin,reservation.message,reservation.statut,vehicule.prixparjour,DATEDIFF(reservation.fin,reservation.debut) as totaldays,reservation.num  from reservation join vehicule on reservation.id_vehi=vehicule.id_vehi  where reservation.email=:useremail AND type=1 order by  reservation.id desc";
