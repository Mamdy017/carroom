          ...
          <div class="row">
               <div class="col-lg-3 col-6">
                    <div class="main-collapse-wrap custom-accordion">
                         <button type="button">Categories de voitures</button>
                         <div id="cataccordion" class="accordion_wrap accordion">


                              <div class="card accordion-item">
                                   <div class="card-header accordion-header">
                                        <button class="btn btn-link accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#catSix">
                         ...
                         <ul class="main-menu">
                              ...
                              <li class="menu-item menu-item-has-children"><a href="#">Pages</a>
                                   <ul class="sub-menu custom">
                                        ...
                                        <li class="menu-item">
                                             <a href="panier.php">Panier de location</a>
                                        </li>
                                        <li class="menu-item">
                                             <a href="vente/vente_panier">Panier d'achat</a>
                                        </li>
                                   </ul>
                              </li>
                                   ...
                                   <ul class="sub-menu custom">
                                        <li class="menu-item menu-item-has-children"><a href="#">Nos Galeries</a>
                                             <ul class="sub-menu custom">
                                                  ...
                                                  <li class="menu-item"><a href="vente/NosVentes.php">Galeries de vente</a>
                                                  </li>
                                             </ul>
                                        </li>
                                   </ul>
