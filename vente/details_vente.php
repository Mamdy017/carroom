          ...
          <div class="row" style="position:center; margin-top: 1.4rem; ">
                    ...
                    <div class="main">
                         ...
                         <div class="signup">
                              <div class="row">
                                   ...
                                   <div class=" col-sm-3 row ">
                                        <div class="col-sm-6 px-1 bor">
                                             <li class="p">Prix unitaire <i class="far fa-sack-dollar i"></i><i class="c" style="font-size: 10px;"><?php if ($produit['prixparjour'] > 0) : ?><?= $produit['prixparjour'] ?> fcfa<?php endif; ?></i></li>
                                        </div>
                                   </div>
               ...
               <div class="col-sm-3 row">
                    <div class="sidebar_widget">
                         ...
                         <form action="vente_panier" method="post">
                              <div class="group">
                              ...
                              <div class="form-group">
                                   chosir le nombre :
                                   <input type="number" class="form-control" name="quantite" value="1" min="1" max="<?= $produit['quantite'] ?>" placeholder="Quantite" required>
     ...
     <section class="section-padding pt-0">
          <div class="container-fluid">
               ...
               <div class="vegetables-slider row">
                    <?php
                    $bid = $_SESSION['nom'];
                    $sql = "SELECT * from  vehicule  where prixparjour=:bid AND statut='Vendre'  ";
