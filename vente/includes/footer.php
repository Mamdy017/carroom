                         ...
                         <div class="newsletter_text">
                              <form action="#" method="POST">
                                   <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="Email Address" autocomplete="off" required name="email">
...
<div class="copyright">
     <div class="container-fluid">
          <p class="mb-0">@Copyright 2022. <a href="#" class="thm-color-one">mamdy017@gmail.com</a> Carrom</p>
     </div>
</div>